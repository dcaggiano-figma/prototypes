...
import { type MenuItemDef, type Mode, renderMenuItems } from './menuTypes';
...
function NavButton({ Icon, label, isActive, showLabel, onClick }: NavButtonProps) {
  return (
    <ButtonPrimitive onClick={onClick} className="group flex flex-col items-center">
      <div
        className={clsx(
