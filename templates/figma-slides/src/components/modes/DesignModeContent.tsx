...
type RightPanelTab = 'design' | 'animate';
const TAB_MAP: Record<RightPanelTab, true> = { design: true, animate: true };
...
export function DesignModeContent() {
  ...
  return (
    <>
      {/* Tabbed header with zoom */}
      <div className="border-b border-border flex items-center justify-between pt-1 pb-2 px-2">
        <Tabs.TabStrip manager={tabManager}>
          <Tabs.Tab {...tabPropsMap.design}>Design</Tabs.Tab>
          <Tabs.Tab {...tabPropsMap.animate}>Animate</Tabs.Tab>
        </Tabs.TabStrip>
      ...
      {/* Animate tab content - placeholder */}
      <Tabs.TabPanel {...tabPanelPropsMap.animate} height="fill">
        <div className="flex-1 flex items-center justify-center p-3">
          <span className="text-bodyMd text-text-secondary">Prototype interactions and animations</span>
        </div>
      </Tabs.TabPanel>
    </>
  );
