...
import { Icon24FigmaLarge, Icon24Search } from '@figma/fpl-icons';
...
export function MainMenu({ themeSetting, onThemeChange, onSaveAsDefault, onOpenPatternLibrary, onOpenUserConfig }: MainMenuProps) {
  ...
  const menuItems: MenuItemDef[] = [
    { type: 'item', id: 'actions', label: 'Actions...', icon: Icon24Search, shortcut: '⌘K', onClick: () => actionRegistry.dispatch('quick-actions') },
    { type: 'separator' },
